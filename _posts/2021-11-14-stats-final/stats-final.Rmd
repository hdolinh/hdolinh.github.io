...
```{r, fig.height=3.5, fig.width=5.5, fig.cap="Interaction effect of year and region on well depth. The interaction effect is significant with a p-value < 0.00000000000000022 at the 0.01 significance level. Adjusted R-squared value is 0.7563347."}
