...
monthly_depth <- region_north_south %>% 
  ...
  mutate(month_year_completed = as.yearmon(paste0(year_completed, month_completed), "%Y %m")) %>% #as.yearmon turns my month_year_completed column into a yearmon object
  mutate(month_year_completed = yearmonth(month_year_completed)) %>% #used yearmonth to turn it into a date object
